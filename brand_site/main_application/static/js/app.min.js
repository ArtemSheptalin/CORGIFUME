...
let slider_about = new Swiper('.aboutt__block', {
	/*
	effect: 'fade',
	autoplay: {
		delay: 3000,
...
let blogSlider = new Swiper('.blogg__block', {
	/*
	effect: 'fade',
	autoplay: {
		delay: 3000,
...
let dataField = document.getElementById('birthId');
dataField.addEventListener('input', () => {
	let input = dataField.value;
	let pattern = /^\d{2}\.\d{2}\.\d{4}$/;
	if (input === '' || !pattern.test(input)) {
		dataField.parentElement.classList.remove('_ok');
		dataField.parentElement.classList.add('_error');
		dataField.classList.remove('_ok');
        dataField.classList.add('_error');
    } else {
        form_remove_error(input);
    }
})
